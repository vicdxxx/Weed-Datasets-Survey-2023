...
Beck, M. A., Liu, C. Y., Bidinosti, C. P., Henry, C. J., Godee, C. M., & Ajmani, M. (2021). Presenting an extensive lab-and field-image dataset of crops and weeds for computer vision tasks in agriculture. arXiv preprint arXiv:2108.05789. [[scholar]](https://scholar.google.com/scholar?hl=en&as_sdt=0%2C23&q=An+extensive+lab-+and+field-image+dataset+of+crops+and+weeds+for+computer+vision&btnG=)  [[paper]](https://www.cs.usask.ca/faculty/stavness/cvppa2021/abstracts/Beck_07.pdf)  [[dataset]](https://datacommons.cyverse.org/browse/iplant/home/shared/commons_repo/curated/TerraByte_PlantLabImages_2021)
...
Ahmad, A., Saraswat, D., Aggarwal, V., Etienne, A., & Hancock, B. (2021). Performance of deep learning models for classifying and detecting common weeds in corn and soybean production systems. Computers and Electronics in Agriculture, 184, 106081. [[scholar]](https://scholar.google.com/scholar?hl=en&as_sdt=80000007&as_ylo=2020&as_yhi=2023&q=Performance+of+deep+learning+models+for+classifying+and+detecting+common+weeds+in+corn+and+soybean&btnG=)  [[paper]](https://www.sciencedirect.com/science/article/pii/S0168169921000995)  [[dataset]](https://github.com/DigitalAgricultureDiscovery/AgBotSamples)

RV, N., Krishnan, A., Krishnan K, V., & Haritha ZA, S. A. (2021, February). Southern Pea/Weed Field Image Dataset for Semantic Segmentation and Crop/Weed Classification using an Encoder-Decoder Network. In Proceedings of the International Conference on Systems, Energy & Environment (ICSEE). [[scholar]](https://scholar.google.com/scholar?hl=en&as_sdt=80000007&as_ylo=2020&as_yhi=2023&q=Southern+PeaWeed+Field+Image+Dataset+for+Semantic+Segmentation+and+CropWeed+Classification+using+an+Encoder-Decoder+Network&btnG=)  [[paper]](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=3781351)  [[dataset]](https://github.com/NachiRV/PWFID-Pea-Weed-Field-Image-Dataset)
...
dos Santos Ferreira, A., Freitas, D. M., da Silva, G. G., Pistori, H., & Folhes, M. T. (2017). Weed detection in soybean crops using ConvNets. Computers and Electronics in Agriculture, 143, 314-324. [[scholar]](https://scholar.google.com/scholar?q=Weed+detection+in+soybean+crops+using+ConvNets&hl=en&as_sdt=0%2C23&as_ylo=2015&as_yhi=) [[paper]](https://www.sciencedirect.com/science/article/pii/S0168169917301977) [[dataset]](https://data.mendeley.com/datasets/3fmjm7ncc6/2) [[dataset]](https://www.kaggle.com/datasets/fpeccia/weed-detection-in-soybean-crops)
